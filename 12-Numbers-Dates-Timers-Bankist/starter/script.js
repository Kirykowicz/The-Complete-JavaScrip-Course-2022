...
console.log(Number.parseInt('30.3px', 10));
console.log(Number.parseFloat('30.30px', 10));
console.log(Number.parseFloat('   30.30px', 10));
...
const isItEven = n =>
  n % 2 === 0 ? `${n} is an even number` : `${n} is an odd number`;

console.log(isItEven(3));

labelBalance.addEventListener('click', function () {
  [...document.querySelectorAll('.movements__row')].forEach(function (row, i) {
    if (i % 2 === 0) row.style.backgroundColor = 'orange';
    if (i % 3 === 0 && i !== 0) row.style.backgroundColor = 'blue';
  });
});
 */
...
console.log(now);
console.log();
console.log(new Date('April 11, 1928'));
